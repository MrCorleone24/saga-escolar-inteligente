    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        >
          ...
          <form className="space-y-3" onSubmit={e => e.preventDefault()}>
            {!isLogin && (
              <Input placeholder="Nome completo" className="h-11" />
            )}
            <div className="relative">
              <Mail className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" size={16} />
              <Input placeholder="Email" type="email" className="h-11 pl-10" />
            </div>
            <div className="relative">
            ...
            <Link to={dashboardPaths[selectedRole]}>
              <Button className="w-full h-11 gradient-hero border-0 text-primary-foreground font-semibold mt-2">
      ...
      <div className="hidden lg:flex flex-1 gradient-hero items-center justify-center p-10 relative overflow-hidden">
        ...
        <motion.div
          ...
          className="relative text-center text-primary-foreground z-10"
        >
          ...
          <p className="text-primary-foreground/70 max-w-xs mx-auto">
            IA pedagógica, gamificação e monitoramento completo para transformar a educação brasileira.
          </p>
        </motion.div>
      </div>
    </div>
